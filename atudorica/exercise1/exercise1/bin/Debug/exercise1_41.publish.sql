...
AS
	...
	INSERT INTO [User] (Email, Username, [Password], FirstName, LastName, MoreInfo) VALUES ('andreitudoricacj@gmail.com','andreitudorica',Convert(nvarchar(50),HASHBYTES ('MD2','andrei')),'andrei','tudorica',6);
